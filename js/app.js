...
function checkSubscriptionValue(){
      ...
      if(del_option == "buy_subscription"){
        ...
        console.log("preferred_amt : " + preferred_amt);
        console.log("parseInt(preferred_amt) : " + parseInt(preferred_amt));
        ...
        app.request({
          ...
          success: function(response){
            ...
            if(itemsResponse["status"] == 1){
              ...
              app.dialog.alert("Click 'Make Payment On Slydepay', make payment on Slydepay's website, and AFTER YOU FINISH PAYMENT ON SLYDEPAY, click the 'Record Payment' Button ", "Alert");
